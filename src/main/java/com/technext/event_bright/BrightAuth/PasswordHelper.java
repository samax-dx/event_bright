package com.technext.event_bright.BrightAuth;
...
public class PasswordHelper {
    ...
    public PasswordPair createPasswordPairAuto(String salt) throws Exception {
        return createPasswordPair(String.valueOf((long) Math.floor(Math.random() * 1000000)), salt);
    }
